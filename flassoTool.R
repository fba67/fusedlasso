...
coefficients.barplot(beta.mat.med,'','sum over the bins',feature.names)
bins.barplot(beta.mat.med,'Bins','sum over features',seq(-floor(bin.cnt/2)+1,floor(bin.cnt/2),1))
dev.off()
